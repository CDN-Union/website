(function() {
  ...
  var ww = document.documentElement.clientWidth < 1200 ? 1200 : document.documentElement.clientWidth,
    wh = 200;
  var relX = (ww - 1200) / 2 + 403,
    relY = 54;
  ...
  var simg1 = new Image();
  simg1.src = "http://i8.pdim.gs/8c65447be72657ec1cfa8dc186266d03.png";
  var simg2 = new Image();
  simg2.src = "http://i5.pdim.gs/fe3a60bbed810387221569c91a09c3a6.png";
  var simg3 = new Image();
  simg3.src = "http://i5.pdim.gs/c1cfc46b184ffb253187915294a9f227.png";
  ...
  var randomer = {
    ...
    ranPos: function() {
      return {
        x: Math.ceil(Math.random() * (ww - 40) + 20),
        y: Math.ceil(Math.random() * (wh - 200))
      };
    }
  };
